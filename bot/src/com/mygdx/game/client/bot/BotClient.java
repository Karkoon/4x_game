...
public class BotClient {
  ...
  public void run() {
    ...
    while (true) {
      var availableCoordinates = CoordinateUtil.getAvailableCoordinates(currentCoordinates);
      var nextMove = random.nextInt(0, availableCoordinates.size());
      var newMove = availableCoordinates.get(nextMove);
      var newCoordinates = CoordinateUtil.mapMoveToCoordinate(currentCoordinates, newMove);
...
//      Coordinates newCoordinates = CoordinateUtil.mapMoveToCoordinate(currentCoordinates, newMove);
      ...
      var reward = getReward(currentCoordinates, newCoordinates);
