...
public class StarBackgroundGame {
  ...
  public StarBackgroundGame(
    ...
    nebulaShader = createShader(MenuScreenAssetPaths.NEBULA_SHADER, 8, 8);
    starShader = createShader(MenuScreenAssetPaths.STARS_SHADER, 4, 4);
  }
  ...
  private ShaderProgram createShader(String path, int noiseValue, int shaderNoiseValue) {
    var shader = assets.getShaderProgram(path);
    shader.bind();
    noise.bind(noiseValue);
    shader.setUniformi("u_noise", shaderNoiseValue);
