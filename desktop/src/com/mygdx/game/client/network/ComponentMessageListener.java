...
public class ComponentMessageListener extends AbstractWebSocketListener {
  ...
  @Inject
  public ComponentMessageListener(NetworkWorldEntityMapper networkWorldEntityMapper) {
  ...
  public interface Handler {
     ...
     * @param worldEntity translated entity receiving the component.
     * @param component   component data from network.
